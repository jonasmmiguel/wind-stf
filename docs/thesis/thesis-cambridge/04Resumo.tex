...
O eventual aumento na acurácia de predição frequentemente exige modelos mais complexos, que implicam em custos de desenvolvimento maiores.
...
A comparação é feita num uso de caso de predição de geração eólica de energia na Alemanha.
Os resultados indicam que a aplicação de métodos de deep learning pode implicar em ganhos de acurácia de até $30\%$ quando séries temporais são modeladas individualmente, e de até $50\%$ quando incorporamos correlações espaço-temporais.
\\[3\baselineskip]
%
